...
def create_instruction_frame(frame, text, distance_text=''):
    ...
    cv2.putText(instruction_frame, text, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,0), 2)
                                    ...
                                    for face_landmark in results.multi_face_landmarks:
                                        ...
                                        if elapsed_time > 3.5 and calculation_started:
                                            ...
                                            if eye == 'right':
                                                ...
                                                dev_pd = dev_pixels * wcr
                                                deviationsr.append(dev_pd)
                                                pdr.append(dev_pd*15)
                                            else: 
                                                ...
                                                dev_pixels = abs(point1[0]-point2[0])
                                                dev_pd = dev_pixels * wcr
                                                deviationsl.append(dev_pd)
                                                pdl.append(dev_pd*15)
                                            break
                                        ...
                                        frame_with_text = create_instruction_frame(frame, instruction_text, str(dist))
